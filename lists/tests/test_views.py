...
class ListViewTest(TestCase):
    ...
    def test_displays_only_items_for_that_list(self):
        ...
        Item.objects.create(text='another list item1', list=other_list)
        Item.objects.create(text='another list item2', list=other_list)
        response = self.client.get(f'/lists/{correct_list.id}/')

        self.assertContains(response, 'item1')
        self.assertContains(response, 'item2')

        self.assertNotContains(response, 'another list item1')
        self.assertNotContains(response, 'another list item2')
    ...
    def test_can_save_a_POST_request_to_an_existing_list(self):
        ...
        text = Item.objects.first()
        self.assertEqual(text.text, 'A new item for an existing list')
        self.assertEqual(text.list, correct_list)
...
class NewListViewIntegratedTest(TestCase):
    def test_can_save_a_POST_request(self):
        ...
        self.assertEqual(Item.objects.count(), 1)
        text = Item.objects.first()
        self.assertEqual(text.text, 'A new list item')
...
class MyListTest(TestCase):
    ...
    def test_my_lists_url_renders_my_lists_template(self):
        ...
        response = self.client.get(f'/lists/users/a@b.com/')
